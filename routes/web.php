...
Route::middleware('auth')->group(function () {
    ...
    Route::get('/laporankeluar/print', [LaporanKeluarController::class, 'print'])->name('laporankeluar.print');
    Route::get('/laporankeluar/export', [LaporanKeluarController::class, 'export'])->name('laporankeluar.export');
